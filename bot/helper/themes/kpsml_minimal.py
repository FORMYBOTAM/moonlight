...
class KPSMLStyle:
    ...
    ST_BN1_NAME = '🤖 HG Bots'
    ST_BN1_URL = 'https://telegram.me/NOWHERE'
    ST_BN2_NAME = 'Updates 🔥'
    ST_BN2_URL = 'https://telegram.me/NOWHERE'
...
Type {help_command} to get a list of available commands</b>'''
    ...
    ST_UNAUTH = '''<i>You Are not authorized user! Deploy your own HGML-X Mirror-Leech bot</i>'''
